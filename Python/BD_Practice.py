...
list1=[10,20,30,40,67] # 4 elements will only be added because the second list has only 4 elements 
list11=[12,13,14,15] # only 4 elements here in list11
var_1:int=45
var_2:int=34
lambda_example=lambda x : x*x
print(lambda_example(var_2))
map_lambda=list(map(lambda x,y : x+y  , list1 , list11))
print(map_lambda)
reduce_lambda=reduce(lambda x,y : x+y , list1)
print(reduce_lambda)
lambda_example2 = lambda a,b : a+b
print(lambda_example2(var_1 , var_2))
map_lambda_1 = list(map(lambda x,y : x*y  , list1 , list11))
print( map_lambda_1)

#ternary operator 
boolean = True if var_1%2==0 else False 
print(boolean)
#ternary operator 
boolean = True if var_2%2==0 else False 
print(boolean)
